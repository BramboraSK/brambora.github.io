...
String.prototype.latinize = function() {
    return this.replace(/[^A-Za-z0-9\[\] ]/g, function(a) { return latin_map[a] || a });
};
...
const laska = (input1, input2, id) => {
    hash1 = getHash(document.getElementById(input1).value.toLowerCase().latinize());
